...
public class LevelManager {
    ...
    private LevelManager(){
        ...
        levelGraphics = new LevelGraphics("/livelli/livello1/Stage1.png");
        ...
        level = new Level(getLvlData("/livelli/livello1/lvl2Data.png"));
        levelGraphics = new LevelGraphics("/livelli/livello1/Stage1.png");
        level.addObserver(levelGraphics);
        levels.add(level);
        levelGraphicsArrayList.add(levelGraphics);
        level = new Level(getLvlData("/livelli/livello1/lvl3Data.png"));
        levelGraphics = new LevelGraphics("/livelli/livello1/Stage1.png");
        level.addObserver(levelGraphics);
        levels.add(level);
        levelGraphicsArrayList.add(levelGraphics);
        level = new Level(getLvlData("/livelli/livello2/lvl4Data.png"));
        levelGraphics = new LevelGraphics("/livelli/livello2/Stage2.png");
        level.addObserver(levelGraphics);
        levels.add(level);
        levelGraphicsArrayList.add(levelGraphics);
        level = new Level(getLvlData("/livelli/livello2/lvl5Data.png"));
        levelGraphics = new LevelGraphics("/livelli/livello2/Stage2.png");
        level.addObserver(levelGraphics);
        levels.add(level);
        levelGraphicsArrayList.add(levelGraphics);
